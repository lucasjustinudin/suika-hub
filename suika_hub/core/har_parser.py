...
class HARParser:
    ...
    def extract_cookies(self, domain: str | None = None) -> dict[str, str]:
    ...
    def extract_headers(self, domain: str | None = None) -> dict[str, str]:
    ...
    def extract_endpoints(self, domain: str | None = None) -> list[dict]:
    ...
    def extract_api_patterns(self, domain: str | None = None) -> dict:
    ...
    def get_session_info(self, domain: str | None = None) -> dict:
