                    ...
                    if uid:
                        ...
                        if sensitive:
                            self.add_finding(
                                ...
                                description=f"Leaderboard response contains sensitive user data",
                ...
                if resp["status"] == 200 and resp["body"]:
                    ...
                    if has_data:
                        self.add_finding(
                            ...
                            description=f"Authenticated user can access another user's data",
                            url=f"{base}{endpoint}",
                ...
                if isinstance(body, dict):
                    ...
                    if is_private or slug in ("admin", "internal", "private", "staging"):
                        self.add_finding(
                            ...
                            description=f"Internal/private program metadata is accessible",
